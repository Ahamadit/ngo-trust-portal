        ...
        <div class="col-lg-10 col-md-12">
            ...
            <div class="card shadow custom-card">
                ...
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="add_our_team.php" class="btn btn-light text-primary fw-bold btn-custom">
                        ➕ Add Our Team
                    </a>
                </div>
                            ...
                            <tbody>
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<td>
                                                <a href='edit_our_team.php?id=" . $row['id'] . "' class='btn btn-sm btn-warning btn-custom'>Edit</a>
                                                <a href='delete_our_team.php?id=" . $row['id'] . "' class='btn btn-sm btn-danger btn-custom' 
...
if(msg){
    if(msg == 'deleted'){
        Swal.fire({
            ...
            window.location.href = 'our_team.php'; // Remove msg from URL
        });
    } else if(msg == 'error'){
        Swal.fire({
            title: 'Error!',
